...
function getFbnOutboundFee(
  ...
  const baseFee = lowASP
    ? 10
    : 12;

  const additionalKg =
    Math.min(weightKg, 12) - 3;
...
export function calculateNoonUAE(
